...
## [3.10.0](https://github.com/eatmyrust/fluent-operator/compare/v3.9.0...v3.10.0) (2026-07-08)


### Features

* add E2E deployment test for Fluentd ([#1849](https://github.com/eatmyrust/fluent-operator/issues/1849)) ([4c8aff6](https://github.com/eatmyrust/fluent-operator/commit/4c8aff63b51a431a4bc5062137f54552a468bcab))
* add envFrom support for fluentd daemonset and statefulsets ([bda6ebd](https://github.com/eatmyrust/fluent-operator/commit/bda6ebd22e401e9af201a1975b05ad38c12331a8))
* add generated CRD manifests and tests for grep logical_op ([2278374](https://github.com/eatmyrust/fluent-operator/commit/2278374229fd2b4ade2bf0bfcbaa3fe275a5962b))
* Add livenessProbe to FluentBit template (fluentbit-fluentBit.yaml) ([6187276](https://github.com/eatmyrust/fluent-operator/commit/61872761f043f2a7663ab9e08654536a74d0ff11))
* add logical_op support to grep filter ([83fa1bb](https://github.com/eatmyrust/fluent-operator/commit/83fa1bbc23f0f095562eebb1c356d09d5c173d9e)), closes [#1316](https://github.com/eatmyrust/fluent-operator/issues/1316)
* add pipeline to bump fluent bit version ([#1448](https://github.com/eatmyrust/fluent-operator/issues/1448)) ([9798273](https://github.com/eatmyrust/fluent-operator/commit/9798273621be71d9177095dd5a8ffacc034e4582))
* add servicemonitor for fluent-operator to helm chart ([#1677](https://github.com/eatmyrust/fluent-operator/issues/1677)) ([cb12b1a](https://github.com/eatmyrust/fluent-operator/commit/cb12b1a0cbebe7cc89b7b41776747d25d913ad44))
* add storage.path support to tail and systemd input plugins ([#1901](https://github.com/eatmyrust/fluent-operator/issues/1901)) ([ff0fee9](https://github.com/eatmyrust/fluent-operator/commit/ff0fee951c7ce19bcfee01fcb4a2b3163be6f135))
* add storage.total_limit_size support to http output ([#1865](https://github.com/eatmyrust/fluent-operator/issues/1865)) ([1b098bf](https://github.com/eatmyrust/fluent-operator/commit/1b098bf9bcc82dba38103510ae4fa465bfee510e))
* Add structured metadata support for Loki output plugin ([b50c4ad](https://github.com/eatmyrust/fluent-operator/commit/b50c4ad00f70d493c6b804f9170b2cb3917828f0))
* add support for envfrom on fluentd ([b0a5b82](https://github.com/eatmyrust/fluent-operator/commit/b0a5b821d572e870d4f9340d7a99ceb20ed9cdd7))
* Add support for reload_after, sniffer_class_name es output parameters ([6c6016a](https://github.com/eatmyrust/fluent-operator/commit/6c6016a2ccd2600f86dfd423cbf32b4933facde8))
* Add support for reload_after, sniffer_class_name es output parameters ([68171fe](https://github.com/eatmyrust/fluent-operator/commit/68171fee3231ac874785566b73bf18ba9e6208aa))
* adjust fluentbit `service` helm value to allow specifying all possible service fields ([25506ac](https://github.com/eatmyrust/fluent-operator/commit/25506ac8e52a16844b191e237ebb955dd1d5584d))
* **charts:** Add ability for custom `positionDB` for `FluentBit` ([a28a662](https://github.com/eatmyrust/fluent-operator/commit/a28a6625619914d4c510442c74973067eae4ffe1))
* **charts:** Add ability for custom `positionDB` for `FluentBit` ([87b933c](https://github.com/eatmyrust/fluent-operator/commit/87b933c6cdf58bef188c38f01d7b188c3520c181))
* FluentBit annotations via operator chart values ([a473d4a](https://github.com/eatmyrust/fluent-operator/commit/a473d4a0561e7a80e55a323542e23190dc14b4b7))
* FluentBit annotations via operator chart values ([#1986](https://github.com/eatmyrust/fluent-operator/issues/1986)) ([28ca0fd](https://github.com/eatmyrust/fluent-operator/commit/28ca0fd0d50272552080cb0e576657b8439f0e34))
* **fluentbit:** add enable_flb_null to fluentbit filter params ([47295c7](https://github.com/eatmyrust/fluent-operator/commit/47295c7e5d4593b641c25ab8497a444f10556732))
* **fluentbit:** add retainMetadataInForwardMode to forward output pl… ([#1973](https://github.com/eatmyrust/fluent-operator/issues/1973)) ([b212a5c](https://github.com/eatmyrust/fluent-operator/commit/b212a5c458325fa666dcfbb2473d3cfaf0ccfe01))
* **fluentbit:** add scheduler.base and scheduler.cap Service configuration ([#1842](https://github.com/eatmyrust/fluent-operator/issues/1842)) ([5424830](https://github.com/eatmyrust/fluent-operator/commit/542483041b4a8472010421585176d7db36627934)), closes [#1838](https://github.com/eatmyrust/fluent-operator/issues/1838)
* **fluentbit:** add support for multiline_buffer_limit configuration to FluentBitConfig and ClusterFluentBitConfig ([#1877](https://github.com/eatmyrust/fluent-operator/issues/1877)) ([84a3076](https://github.com/eatmyrust/fluent-operator/commit/84a3076ef2b7ea4f4143bb030985cb5e06a8c8de))
* **fluentbit:** add text_payload_key to stackdriver ([#1669](https://github.com/eatmyrust/fluent-operator/issues/1669)) ([1f87640](https://github.com/eatmyrust/fluent-operator/commit/1f8764035c5dd2134f8ebd4978950547c8a9b4ef))
* **fluentbit:** adds support for workers to syslog output ([#1874](https://github.com/eatmyrust/fluent-operator/issues/1874)) ([4f0160c](https://github.com/eatmyrust/fluent-operator/commit/4f0160cc50b37f4fefe4ce79f6cce57bd650e049))
* **fluentbit:** support more settings for firehose output ([f577907](https://github.com/eatmyrust/fluent-operator/commit/f577907537cbc798185d37d8bd6d3733004548b4))
* **fluentbit:** support networking settings for s3 output ([7c51546](https://github.com/eatmyrust/fluent-operator/commit/7c515469e9a48a64aad249d6a9a3ab3a78b0c5b9))
* **fluentd:** add null output plugin ([5486405](https://github.com/eatmyrust/fluent-operator/commit/5486405d298f98f4624d3d7ec021408a3b08b1be))
* **fluentd:** add pluginSortOrder field to control plugin [@id](https://github.com/id) sort behavior ([52c62b6](https://github.com/eatmyrust/fluent-operator/commit/52c62b697266ad75d323a14dc1bdb81746996150))
* **helm/fluent-operator:** add option to disable rbac creation ([#1556](https://github.com/eatmyrust/fluent-operator/issues/1556)) ([087a7da](https://github.com/eatmyrust/fluent-operator/commit/087a7dab06295a84287f192afff1b7b5b1769624))
* **helm:** add namespaceOverride support to FluentBit chart ([af76698](https://github.com/eatmyrust/fluent-operator/commit/af7669857f85f115e1baf9254cda4d7a2cb72a9f)), closes [#1918](https://github.com/eatmyrust/fluent-operator/issues/1918)
* improve pipelines and add documents ([dd91ab5](https://github.com/eatmyrust/fluent-operator/commit/dd91ab526453dfdbb7706b2bbb1ec8fb48d6a003))
* release 3.3.0 ([6cbb560](https://github.com/eatmyrust/fluent-operator/commit/6cbb560e437395b6e80b770b9db6c89d0f107498))
* **roles:** Allow to change name of serviceAccount, clusterRole and clusterRoleBinding ([#1748](https://github.com/eatmyrust/fluent-operator/issues/1748)) ([787d2df](https://github.com/eatmyrust/fluent-operator/commit/787d2df25f096d11571d263422841e289c366708))
* update pr as requested ([9dd2abf](https://github.com/eatmyrust/fluent-operator/commit/9dd2abf30d1a4a430a40afe95ec25edc557bdfbe))


### Bug Fixes

* add signoff to release pr ([66c107c](https://github.com/eatmyrust/fluent-operator/commit/66c107c62d520e2173e0b1e114a9d69ac390e64f))
* **collector:** pass storageClassName to generated StatefulSet PVC ([#1963](https://github.com/eatmyrust/fluent-operator/issues/1963)) ([8d0c3ad](https://github.com/eatmyrust/fluent-operator/commit/8d0c3ad84b1af8d0e8ac80d9b764e7203e276792))
* correct parameter name from ca_certPath to ca_cert_path ([fe64c66](https://github.com/eatmyrust/fluent-operator/commit/fe64c668a09009248b6f14f6db0a950d3e25e975))
* correct parameter name from client_certAuth to client_cert_auth ([4b15c26](https://github.com/eatmyrust/fluent-operator/commit/4b15c26337ae1b1b8236fafe3bdaa1d8c29f4246)), closes [#1819](https://github.com/eatmyrust/fluent-operator/issues/1819)
* **crd:** add `properties: {}` to logfmt parser to prevent null config from crashing fluent-bit ([deb8c0b](https://github.com/eatmyrust/fluent-operator/commit/deb8c0b61355848193c5bbd63503ac5646a9f03a))
* **crd:** disallow null values for logfmt parser to prevent fluent-bit crash ([0ee3330](https://github.com/eatmyrust/fluent-operator/commit/0ee3330043b6e97a5a03afeef556b421ae431de3))
* **crd:** disallow null values for logfmt parser to prevent fluent-bit crash ([e3f8a50](https://github.com/eatmyrust/fluent-operator/commit/e3f8a50ea7ced27d8fc5d6c8d17d2fdb83e17900))
* **crd:** disallow null values for logfmt parser to prevent fluent-bit crash ([6c79dfd](https://github.com/eatmyrust/fluent-operator/commit/6c79dfdce9831b2892616c2b42ae257dcb1ce896))
* **crd:** disallow null values for logfmt parser to prevent fluent-bit crash ([8f2198e](https://github.com/eatmyrust/fluent-operator/commit/8f2198efa58bb16a9409f0aba83831e4868ba710))
* **doc:** open_search.md referencing elasticsearch name ([#1408](https://github.com/eatmyrust/fluent-operator/issues/1408)) ([17d8068](https://github.com/eatmyrust/fluent-operator/commit/17d8068794ac80c9097b42a60a4b5a0c2b178d6a))
* fix pipeline bugs and improve the validation ([a4180d4](https://github.com/eatmyrust/fluent-operator/commit/a4180d4128ff73b40619f3b561526b027a3930cf))
* fix the e2e test script for fluentd ([#1791](https://github.com/eatmyrust/fluent-operator/issues/1791)) ([a77cbef](https://github.com/eatmyrust/fluent-operator/commit/a77cbef92e5bd518e5082a8d5ac91189c948423a))
* **fluent-operator:** broken link about nodeselector ([#1626](https://github.com/eatmyrust/fluent-operator/issues/1626)) ([8a954f8](https://github.com/eatmyrust/fluent-operator/commit/8a954f81dc2e195bdae763a737ffc60b396e03b5))
* **fluentbitconfig:** hash-based compare to prevent unnecessary updates ([c4ee008](https://github.com/eatmyrust/fluent-operator/commit/c4ee008da234bc1ef528e8946d87ec87bad2e6d6))
* **fluentbitconfig:** hash-based compare to prevent unnecessary updates ([19cdbac](https://github.com/eatmyrust/fluent-operator/commit/19cdbac7376497088a5a30c1a9342cb4884d40cc))
* format go files and regenerate manifests with networking description ([d424f6c](https://github.com/eatmyrust/fluent-operator/commit/d424f6ca9fb276959acf79d287853cc9915fbbbf))
* Invalid reference ([5fe89ee](https://github.com/eatmyrust/fluent-operator/commit/5fe89ee30323d1efa9d098c3c6e40e29c2470dc4))
* missing cloudAuth/cloudId pair inserts ([2f1c90b](https://github.com/eatmyrust/fluent-operator/commit/2f1c90b35e43c2b257559039e3c24775e0a3587d))
* missing cloudAuth/cloudId pair inserts ([842c7e2](https://github.com/eatmyrust/fluent-operator/commit/842c7e27dfe3d7af515c5bab59be35d2e42d21f7))
* remove quote filter from boolean disableLogVolumes in helm template ([5ff5e89](https://github.com/eatmyrust/fluent-operator/commit/5ff5e892a7a0a02acb09fdaeb8b1bf2f64c1df50))
* remove quote filter from boolean disableLogVolumes in helm template ([eab0391](https://github.com/eatmyrust/fluent-operator/commit/eab0391cebd3223400f9e0fbe7ea810220dcc84c)), closes [#1871](https://github.com/eatmyrust/fluent-operator/issues/1871)
* Update outdated crds ([254c687](https://github.com/eatmyrust/fluent-operator/commit/254c6877aa673baa9ee537fa4efff90a3a7603cd))
* use fully-qualified DNS name in Fluent Bit ClusterOutput ([2b4eabd](https://github.com/eatmyrust/fluent-operator/commit/2b4eabd2122df0b4cc2d39b626f2cd41555cc849)), closes [#1794](https://github.com/eatmyrust/fluent-operator/issues/1794)


### Reverts

* undo accidental release 3.9.0 on master ([#1976](https://github.com/eatmyrust/fluent-operator/issues/1976)) ([23e1906](https://github.com/eatmyrust/fluent-operator/commit/23e1906cb26104440a3e6a1c38506d97ecd9a355))


### Dependencies

* **deps:** Bump actions/cache from 4.2.2 to 4.2.3 ([#1524](https://github.com/eatmyrust/fluent-operator/issues/1524)) ([9e18d8e](https://github.com/eatmyrust/fluent-operator/commit/9e18d8eb8547ee0a71ce8f0ad7f186685c783748))
* **deps:** Bump actions/checkout from 3 to 4 ([#1394](https://github.com/eatmyrust/fluent-operator/issues/1394)) ([25287ce](https://github.com/eatmyrust/fluent-operator/commit/25287ce20e8e04ec083683346d472380b48f5d63))
* **deps:** Bump actions/checkout from 4.2.2 to 5.0.0 ([18e01d4](https://github.com/eatmyrust/fluent-operator/commit/18e01d4819b5afe72fc61af02f3e0bc2a426ba6b))
* **deps:** Bump actions/checkout from 5.0.0 to 6.0.1 ([aa46440](https://github.com/eatmyrust/fluent-operator/commit/aa4644051038791a221ce2ce88724db57de270df))
* **deps:** Bump actions/checkout from 6.0.1 to 6.0.2 ([#1860](https://github.com/eatmyrust/fluent-operator/issues/1860)) ([235ee7f](https://github.com/eatmyrust/fluent-operator/commit/235ee7fe78f567130b4391ba7cef1a53ddcedda0))
* **deps:** Bump actions/setup-go from 5.3.0 to 5.4.0 ([#1525](https://github.com/eatmyrust/fluent-operator/issues/1525)) ([e68f62b](https://github.com/eatmyrust/fluent-operator/commit/e68f62b097c1499707a60e8fed37461b8bb82b3e))
* **deps:** Bump actions/setup-go from 5.4.0 to 5.5.0 ([#1629](https://github.com/eatmyrust/fluent-operator/issues/1629)) ([e626f2c](https://github.com/eatmyrust/fluent-operator/commit/e626f2c135819839e5eedca38d5237a929ad2ba1))
* **deps:** Bump actions/setup-go from 5.5.0 to 6.0.0 ([3cb7a99](https://github.com/eatmyrust/fluent-operator/commit/3cb7a99b0d65a081dd2437993bb3cf5fdd5edec3))
* **deps:** Bump actions/setup-go from 6.0.0 to 6.2.0 ([#1857](https://github.com/eatmyrust/fluent-operator/issues/1857)) ([c15392b](https://github.com/eatmyrust/fluent-operator/commit/c15392b6d96e72a71e692776db78222edcf7e2d7))
* **deps:** Bump actions/setup-go from 6.2.0 to 6.3.0 ([#1888](https://github.com/eatmyrust/fluent-operator/issues/1888)) ([b853f23](https://github.com/eatmyrust/fluent-operator/commit/b853f237bc1f0e99aa7fd293095263b2d09364bb))
* **deps:** Bump actions/setup-go from 6.3.0 to 6.4.0 ([#1939](https://github.com/eatmyrust/fluent-operator/issues/1939)) ([975ac86](https://github.com/eatmyrust/fluent-operator/commit/975ac86ba3be6de6154f6ccd8efecd7bfc0291ee))
* **deps:** Bump alpine in /cmd/fluent-watcher/fluentd ([#1434](https://github.com/eatmyrust/fluent-operator/issues/1434)) ([09d04d5](https://github.com/eatmyrust/fluent-operator/commit/09d04d5e783bec1ae57615d07e5bdf2fd316865f))
* **deps:** Bump aquasecurity/trivy-action from 0.24.0 to 0.29.0 ([#1426](https://github.com/eatmyrust/fluent-operator/issues/1426)) ([4c7eaa8](https://github.com/eatmyrust/fluent-operator/commit/4c7eaa88c4592a918ad43ec00df9aa496976e931))
* **deps:** Bump aquasecurity/trivy-action from 0.29.0 to 0.30.0 ([#1523](https://github.com/eatmyrust/fluent-operator/issues/1523)) ([57d3661](https://github.com/eatmyrust/fluent-operator/commit/57d366104ac776a38394013f9f88e0d85fb08b65))
* **deps:** Bump aquasecurity/trivy-action from 0.29.0 to 0.30.0 ([#1523](https://github.com/eatmyrust/fluent-operator/issues/1523)) ([#1527](https://github.com/eatmyrust/fluent-operator/issues/1527)) ([a0ea5a1](https://github.com/eatmyrust/fluent-operator/commit/a0ea5a1a7dff9958d86ec9da85dcd5ef53501065))
* **deps:** Bump aquasecurity/trivy-action from 0.30.0 to 0.33.0 ([#1676](https://github.com/eatmyrust/fluent-operator/issues/1676)) ([1d663fc](https://github.com/eatmyrust/fluent-operator/commit/1d663fcb5c4572835d054e15fb556abf71934fee))
* **deps:** Bump aquasecurity/trivy-action from 0.33.0 to 0.33.1 ([dac2bbb](https://github.com/eatmyrust/fluent-operator/commit/dac2bbbf6d4cd99670281cbc0f334e2c5722532c))
* **deps:** Bump arm64v8/ruby in /cmd/fluent-watcher/fluentd ([#1443](https://github.com/eatmyrust/fluent-operator/issues/1443)) ([9fe37ca](https://github.com/eatmyrust/fluent-operator/commit/9fe37ca415615d80ebc1b6b1cd1217539f4caecc))
* **deps:** Bump azure/setup-helm from 4.3.0 to 4.3.1 ([215ef68](https://github.com/eatmyrust/fluent-operator/commit/215ef681fa9e039e4b466ed86cf77e8e170e92b4))
* **deps:** Bump azure/setup-helm from 4.3.1 to 5.0.0 ([#1911](https://github.com/eatmyrust/fluent-operator/issues/1911)) ([d32f55f](https://github.com/eatmyrust/fluent-operator/commit/d32f55f4fab3e9b09a8f7379dc0e3411ac24d087))
* **deps:** Bump docker/build-push-action from 6.15.0 to 6.16.0 ([71e4213](https://github.com/eatmyrust/fluent-operator/commit/71e42133dc1f4c783832068e08c797e67f9b5c19))
* **deps:** Bump docker/build-push-action from 6.16.0 to 6.18.0 ([#1630](https://github.com/eatmyrust/fluent-operator/issues/1630)) ([ab535cf](https://github.com/eatmyrust/fluent-operator/commit/ab535cf5f65cf0ef6eeec8abae55850b424802f5))
* **deps:** Bump docker/build-push-action from 6.18.0 to 6.19.2 ([#1885](https://github.com/eatmyrust/fluent-operator/issues/1885)) ([ae01299](https://github.com/eatmyrust/fluent-operator/commit/ae012997d3316466922bd9051127672b3bf0cf92))
* **deps:** Bump docker/build-push-action from 6.19.2 to 7.0.0 ([#1913](https://github.com/eatmyrust/fluent-operator/issues/1913)) ([2a327c3](https://github.com/eatmyrust/fluent-operator/commit/2a327c3c3a00130d6065cec9a8e88546a236ed42))
* **deps:** Bump docker/build-push-action from 7.0.0 to 7.1.0 ([#1935](https://github.com/eatmyrust/fluent-operator/issues/1935)) ([436244a](https://github.com/eatmyrust/fluent-operator/commit/436244a53d48766221b926857e071658b92f335d))
* **deps:** Bump docker/login-action from 3.4.0 to 3.6.0 ([8ac5612](https://github.com/eatmyrust/fluent-operator/commit/8ac5612a9d3c60827f954890b8376b650e7f5b1d))
* **deps:** Bump docker/login-action from 3.6.0 to 3.7.0 ([#1858](https://github.com/eatmyrust/fluent-operator/issues/1858)) ([4b9296c](https://github.com/eatmyrust/fluent-operator/commit/4b9296c45e27a36a03a2d3f36230879a48cf5f9e))
* **deps:** Bump docker/login-action from 3.7.0 to 4.0.0 ([e3d6a66](https://github.com/eatmyrust/fluent-operator/commit/e3d6a661c49660d6dee11b9269ca49c60dc5c31e))
* **deps:** Bump docker/login-action from 4.0.0 to 4.1.0 ([#1936](https://github.com/eatmyrust/fluent-operator/issues/1936)) ([af377e3](https://github.com/eatmyrust/fluent-operator/commit/af377e3595bee93404f5aa3f0e166feec3111c41))
* **deps:** Bump docker/metadata-action from 5.10.0 to 6.0.0 ([#1910](https://github.com/eatmyrust/fluent-operator/issues/1910)) ([b494b7d](https://github.com/eatmyrust/fluent-operator/commit/b494b7debc949c5c035b11091183b091132fec24))
* **deps:** Bump docker/metadata-action from 5.7.0 to 5.8.0 ([c7ec44d](https://github.com/eatmyrust/fluent-operator/commit/c7ec44d87cdcfc7fb1b2e18b94562d3b6c5172c9))
* **deps:** Bump docker/metadata-action from 5.8.0 to 5.10.0 ([febe659](https://github.com/eatmyrust/fluent-operator/commit/febe65932b2cb35a0834113155921a5d6a6748ea))
* **deps:** Bump docker/setup-buildx-action from 3.10.0 to 3.11.1 ([#1650](https://github.com/eatmyrust/fluent-operator/issues/1650)) ([8d4d8ca](https://github.com/eatmyrust/fluent-operator/commit/8d4d8ca4aaa77140e10d74f49037514ee8b830e7))
* **deps:** Bump docker/setup-buildx-action from 3.11.1 to 3.12.0 ([96f5d5f](https://github.com/eatmyrust/fluent-operator/commit/96f5d5f2e2aef67e00a3a89521240864116befba))
* **deps:** Bump docker/setup-buildx-action from 3.12.0 to 4.0.0 ([#1938](https://github.com/eatmyrust/fluent-operator/issues/1938)) ([4c7be06](https://github.com/eatmyrust/fluent-operator/commit/4c7be064a16850a4563fda71161be1dfe538f9cb))
* **deps:** bump fluent-bit to 5.0.7 ([#1991](https://github.com/eatmyrust/fluent-operator/issues/1991)) ([afcefde](https://github.com/eatmyrust/fluent-operator/commit/afcefde5f19e40fcf8813ebd836c169c4055425b))
* **deps:** bump fluent-bit to 5.0.8 ([#2003](https://github.com/eatmyrust/fluent-operator/issues/2003)) ([a4fe5ae](https://github.com/eatmyrust/fluent-operator/commit/a4fe5aebc3cbae4d79581996d4e581b9c784db3b))
* **deps:** Bump github.com/fsnotify/fsnotify from 1.7.0 to 1.8.0 ([#1396](https://github.com/eatmyrust/fluent-operator/issues/1396)) ([cc06a33](https://github.com/eatmyrust/fluent-operator/commit/cc06a3366bf4f3faf5f99c03a7fd950069d517ce))
* **deps:** Bump github.com/fsnotify/fsnotify from 1.9.0 to 1.10.1 ([#1940](https://github.com/eatmyrust/fluent-operator/issues/1940)) ([0905317](https://github.com/eatmyrust/fluent-operator/commit/0905317f6590c25dfb5bb4d9c42f973cb9e1935d))
* **deps:** Bump github.com/go-logr/logr from 1.4.2 to 1.4.3 ([18f4c35](https://github.com/eatmyrust/fluent-operator/commit/18f4c359de38b9257aaa6309fd09b2a6599f7f4f))
* **deps:** Bump github.com/go-openapi/errors from 0.22.1 to 0.22.3 ([#1712](https://github.com/eatmyrust/fluent-operator/issues/1712)) ([57a16be](https://github.com/eatmyrust/fluent-operator/commit/57a16becc0df11241a9c9d5b33a3db965cf0c934))
* **deps:** Bump github.com/go-openapi/errors from 0.22.3 to 0.22.4 ([0176b49](https://github.com/eatmyrust/fluent-operator/commit/0176b49b4aead2b92603e77a8f7360396319b50d))
* **deps:** Bump github.com/go-openapi/errors from 0.22.4 to 0.22.5 ([12b4fb9](https://github.com/eatmyrust/fluent-operator/commit/12b4fb962d8a2313b3b81ee9c0b83e29178a7e4c))
* **deps:** Bump github.com/go-openapi/errors from 0.22.5 to 0.22.6 ([9d2fc40](https://github.com/eatmyrust/fluent-operator/commit/9d2fc40a2e9cf7443a046078142df4b4264bca13))
* **deps:** Bump github.com/go-openapi/errors from 0.22.6 to 0.22.7 ([57d0e32](https://github.com/eatmyrust/fluent-operator/commit/57d0e32c5cb1f77bd1fc49cc3c81fc0a2da18fba))
* **deps:** Bump github.com/go-openapi/errors from 0.22.7 to 0.22.8 ([#1989](https://github.com/eatmyrust/fluent-operator/issues/1989)) ([2d6abe8](https://github.com/eatmyrust/fluent-operator/commit/2d6abe84c224522415ec9dc8fcc400e743984b8a))
* **deps:** Bump github.com/oklog/run from 1.1.0 to 1.2.0 ([402fa86](https://github.com/eatmyrust/fluent-operator/commit/402fa86100707f43d21f508553a3c9cf5947cf1e))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.23.4 to 2.26.0 ([e6964de](https://github.com/eatmyrust/fluent-operator/commit/e6964de6b7a7673ee391842c4a9c510b5a1203a9))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.26.0 to 2.27.2 ([3d69400](https://github.com/eatmyrust/fluent-operator/commit/3d6940008925735aadc9e5d7e0eda9a48157ef09))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.27.2 to 2.27.3 ([ea6a191](https://github.com/eatmyrust/fluent-operator/commit/ea6a191c9e3e95df3e1ed46ccec2ea1808d0e05c))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.27.3 to 2.27.4 ([6e1313b](https://github.com/eatmyrust/fluent-operator/commit/6e1313bbee3bf3fa408a39c3fd5fe5f1112b3c21))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.27.5 to 2.28.1 ([#1862](https://github.com/eatmyrust/fluent-operator/issues/1862)) ([76d1b4f](https://github.com/eatmyrust/fluent-operator/commit/76d1b4f0b7633214ea4a83389449fb370a7123b9))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.28.1 to 2.28.2 ([032d836](https://github.com/eatmyrust/fluent-operator/commit/032d8361a4c545e427718c7b995abe6cc71585b5))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.28.2 to 2.28.3 ([#1943](https://github.com/eatmyrust/fluent-operator/issues/1943)) ([bacd907](https://github.com/eatmyrust/fluent-operator/commit/bacd907097466a256030cd7852f8712b97daf5e9))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.28.3 to 2.29.0 ([#1959](https://github.com/eatmyrust/fluent-operator/issues/1959)) ([089472f](https://github.com/eatmyrust/fluent-operator/commit/089472f00274e368c5830b30017e9848bb58f047))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.29.0 to 2.30.0 ([#1994](https://github.com/eatmyrust/fluent-operator/issues/1994)) ([f382e73](https://github.com/eatmyrust/fluent-operator/commit/f382e7373667e7043f407c8570210670e50ae096))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.30.0 to 2.31.0 ([0c2b650](https://github.com/eatmyrust/fluent-operator/commit/0c2b650304eda28ebd3bfc4a60b3e1487087de07))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.31.0 to 2.32.0 ([#2001](https://github.com/eatmyrust/fluent-operator/issues/2001)) ([4659215](https://github.com/eatmyrust/fluent-operator/commit/46592153b96b829b3c2c4fa1c986c70fb7346b4b))
* **deps:** Bump github.com/onsi/gomega from 1.34.2 to 1.36.3 ([#1533](https://github.com/eatmyrust/fluent-operator/issues/1533)) ([a5cd696](https://github.com/eatmyrust/fluent-operator/commit/a5cd696abeec59099f3644065b36367d30273716))
* **deps:** Bump github.com/onsi/gomega from 1.38.2 to 1.38.3 ([504ed81](https://github.com/eatmyrust/fluent-operator/commit/504ed81fda684e5817b68288ac010d01bc8ec1eb))
* **deps:** Bump github.com/onsi/gomega from 1.38.3 to 1.39.0 ([73323a1](https://github.com/eatmyrust/fluent-operator/commit/73323a17f753afec378fd9658aebc85224b2f125))
* **deps:** Bump github.com/onsi/gomega from 1.39.0 to 1.39.1 ([#1861](https://github.com/eatmyrust/fluent-operator/issues/1861)) ([30257e1](https://github.com/eatmyrust/fluent-operator/commit/30257e1fc95e73854e7229b5556353c7d8bd8e3a))
* **deps:** Bump github.com/onsi/gomega from 1.40.0 to 1.41.0 ([#1958](https://github.com/eatmyrust/fluent-operator/issues/1958)) ([2f44042](https://github.com/eatmyrust/fluent-operator/commit/2f440424b45a572711818e189a15d841705c3995))
* **deps:** Bump github.com/onsi/gomega from 1.41.0 to 1.42.0 ([d1db129](https://github.com/eatmyrust/fluent-operator/commit/d1db12917d28306dd77e1f59940148307a060b56))
* **deps:** Bump github.com/onsi/gomega from 1.42.0 to 1.42.1 ([#2002](https://github.com/eatmyrust/fluent-operator/issues/2002)) ([8706734](https://github.com/eatmyrust/fluent-operator/commit/87067340d27763c2441d9b90fec3a93a06293c3c))
* **deps:** bump go to v1.26.3 ([7608a7e](https://github.com/eatmyrust/fluent-operator/commit/7608a7ed70b6ab881312d7abed09de2c95881ea4))
* **deps:** bump go to v1.26.3 ([8b9f6ec](https://github.com/eatmyrust/fluent-operator/commit/8b9f6ec3d3ded5f274eb7380d401a7b9b1843d95))
* **deps:** Bump go.opentelemetry.io/otel/sdk from 1.36.0 to 1.40.0 ([#1890](https://github.com/eatmyrust/fluent-operator/issues/1890)) ([5685623](https://github.com/eatmyrust/fluent-operator/commit/5685623c51ff54b373f67eaf20d34d450c504daf))
* **deps:** Bump go.opentelemetry.io/otel/sdk from 1.40.0 to 1.43.0 ([#1920](https://github.com/eatmyrust/fluent-operator/issues/1920)) ([9c0a98c](https://github.com/eatmyrust/fluent-operator/commit/9c0a98c8a9916380fc2adee2d267ab13d12d0f81))
* **deps:** Bump golang in /cmd/fluent-manager ([#1430](https://github.com/eatmyrust/fluent-operator/issues/1430)) ([f8cc0d7](https://github.com/eatmyrust/fluent-operator/commit/f8cc0d7fbccbdda0f2e3d6813177963f4e4aa4dd))
* **deps:** Bump golang in /cmd/fluent-watcher/fluentbit ([#1429](https://github.com/eatmyrust/fluent-operator/issues/1429)) ([966e2d6](https://github.com/eatmyrust/fluent-operator/commit/966e2d668be9309c8372bf30050e74217a9faa28))
* **deps:** Bump golang in /cmd/fluent-watcher/fluentd ([#1431](https://github.com/eatmyrust/fluent-operator/issues/1431)) ([30bb13b](https://github.com/eatmyrust/fluent-operator/commit/30bb13b7d324e0cf89d62f21ba7b8f71eace345c))
* **deps:** Bump golang in /docs/best-practice/forwarding-logs-via-http ([#1446](https://github.com/eatmyrust/fluent-operator/issues/1446)) ([23e1c26](https://github.com/eatmyrust/fluent-operator/commit/23e1c26d9e72203694ce8e36a8f8f68f74dd1af5))
* **deps:** Bump golang.org/x/net from 0.28.0 to 0.33.0 ([#1467](https://github.com/eatmyrust/fluent-operator/issues/1467)) ([4f9d71b](https://github.com/eatmyrust/fluent-operator/commit/4f9d71b21e223f6eaeaacad5d1cae67a6137c0a6))
* **deps:** Bump golang.org/x/sync from 0.13.0 to 0.14.0 ([e45d27b](https://github.com/eatmyrust/fluent-operator/commit/e45d27b9de4a20d480fa8d72fd7f3b89f0962af0))
* **deps:** Bump golang.org/x/sync from 0.14.0 to 0.17.0 ([6478b63](https://github.com/eatmyrust/fluent-operator/commit/6478b63a80cffde0c399ea27822fc13ee3b40ba3))
* **deps:** Bump golang.org/x/sync from 0.17.0 to 0.18.0 ([73613df](https://github.com/eatmyrust/fluent-operator/commit/73613df661f1869db3d2a6434079ec335a659459))
* **deps:** Bump golang.org/x/sync from 0.18.0 to 0.19.0 ([31a4d82](https://github.com/eatmyrust/fluent-operator/commit/31a4d82e1ff54775b0525f3fa01076c7d7e133b5))
* **deps:** Bump golang.org/x/sync from 0.19.0 to 0.20.0 ([00aa011](https://github.com/eatmyrust/fluent-operator/commit/00aa0118cb58ad8b46788dab0a06ab6ead6725da))
* **deps:** Bump golang.org/x/sync from 0.20.0 to 0.21.0 ([#1993](https://github.com/eatmyrust/fluent-operator/issues/1993)) ([71933b9](https://github.com/eatmyrust/fluent-operator/commit/71933b99cb79267c258164514ba7e989ce1d59ff))
* **deps:** Bump golangci/golangci-lint-action from 9.0.0 to 9.1.0 ([2c83a78](https://github.com/eatmyrust/fluent-operator/commit/2c83a7851179779dad402c8aa3607b008d23b4b5))
* **deps:** Bump golangci/golangci-lint-action from 9.1.0 to 9.2.0 ([cdc4cbe](https://github.com/eatmyrust/fluent-operator/commit/cdc4cbe85b1c98e3ca99f07394e5b79fa33c9993))
* **deps:** Bump google.golang.org/grpc from 1.72.2 to 1.79.3 ([a5d6bd1](https://github.com/eatmyrust/fluent-operator/commit/a5d6bd1e36d695de709947101168584fb73c80d8))
* **deps:** Bump helm/chart-testing-action from 2.6.1 to 2.7.0 ([#1487](https://github.com/eatmyrust/fluent-operator/issues/1487)) ([baf5851](https://github.com/eatmyrust/fluent-operator/commit/baf585194704c39d06f4fdb3344bb907c969d1fd))
* **deps:** Bump helm/chart-testing-action from 2.7.0 to 2.8.0 ([d9775e4](https://github.com/eatmyrust/fluent-operator/commit/d9775e49dd51c9882a8e9f377b07fe6ff4b29cd4))
* **deps:** Bump helm/kind-action from 1.10.0 to 1.12.0 ([#1445](https://github.com/eatmyrust/fluent-operator/issues/1445)) ([4329b66](https://github.com/eatmyrust/fluent-operator/commit/4329b660a44639c827fb2a6ceb197c49136cc900))
* **deps:** Bump helm/kind-action from 1.12.0 to 1.13.0 ([#1811](https://github.com/eatmyrust/fluent-operator/issues/1811)) ([d3c279e](https://github.com/eatmyrust/fluent-operator/commit/d3c279e9f2502987bf2bf211888c2fa4cdc418a4))
* **deps:** Bump helm/kind-action from 1.13.0 to 1.14.0 ([#1886](https://github.com/eatmyrust/fluent-operator/issues/1886)) ([211f02e](https://github.com/eatmyrust/fluent-operator/commit/211f02e443f6d365ba79140d621ae9e94a55d3be))
* **deps:** Bump k8s.io/klog/v2 from 2.130.1 to 2.140.0 ([72694b8](https://github.com/eatmyrust/fluent-operator/commit/72694b8ed2a72887e1812ea9e8613bbe3f8198ea))
* **deps:** Bump marcofranssen/setup-kubectl from 1.3.0 to 2.0.0 ([e813005](https://github.com/eatmyrust/fluent-operator/commit/e8130054033ed67947be8867a0725c99414c8359))
* **deps:** Bump marcofranssen/setup-kubectl from 2.0.0 to 2.1.0 ([#1856](https://github.com/eatmyrust/fluent-operator/issues/1856)) ([759e3e0](https://github.com/eatmyrust/fluent-operator/commit/759e3e07f93a008241a7b6b1c5464da300caa502))
* **deps:** Bump peter-evans/create-pull-request from 7 to 8 ([d00fb15](https://github.com/eatmyrust/fluent-operator/commit/d00fb15edd7a7dcf79928837a4d41dfafc481d10))
* **deps:** Bump renovatebot/github-action from 41.0.13 to 41.0.22 ([d3ff64c](https://github.com/eatmyrust/fluent-operator/commit/d3ff64c902d7c14b9c493d9a8c8ed3b3e040a790))
* **deps:** Bump renovatebot/github-action from 41.0.22 to 43.0.10 ([#1675](https://github.com/eatmyrust/fluent-operator/issues/1675)) ([1e58738](https://github.com/eatmyrust/fluent-operator/commit/1e58738b01923e6556e5874e3ca5afd984c00191))
* **deps:** Bump renovatebot/github-action from 43.0.10 to 43.0.14 ([51031c6](https://github.com/eatmyrust/fluent-operator/commit/51031c6c044bb905f5a99bea35224ce28a2360ea))
* **deps:** Bump renovatebot/github-action from 43.0.14 to 43.0.19 ([6d50145](https://github.com/eatmyrust/fluent-operator/commit/6d501452aa3a8fae67c970beb425278585b1528d))
* **deps:** Bump renovatebot/github-action from 43.0.19 to 44.0.5 ([#1808](https://github.com/eatmyrust/fluent-operator/issues/1808)) ([1833150](https://github.com/eatmyrust/fluent-operator/commit/18331503896230549fcf19d304b31049fb25fed1))
* **deps:** Bump renovatebot/github-action from 44.0.5 to 44.2.2 ([1a89a3c](https://github.com/eatmyrust/fluent-operator/commit/1a89a3cc6cf14b80fd5b261c464c38d11066940e))
* **deps:** Bump renovatebot/github-action from 44.2.2 to 46.0.0 ([#1859](https://github.com/eatmyrust/fluent-operator/issues/1859)) ([d4abd53](https://github.com/eatmyrust/fluent-operator/commit/d4abd53defdb09fbf77978ea8bbdb7a07681d8dc))
* **deps:** Bump renovatebot/github-action from 46.0.0 to 46.1.2 ([#1887](https://github.com/eatmyrust/fluent-operator/issues/1887)) ([7bf9253](https://github.com/eatmyrust/fluent-operator/commit/7bf9253af257e9045da4132b79e044bb8d677cbe))
* **deps:** Bump renovatebot/github-action from 46.1.2 to 46.1.7 ([#1912](https://github.com/eatmyrust/fluent-operator/issues/1912)) ([a7c1727](https://github.com/eatmyrust/fluent-operator/commit/a7c1727fabf0c6e4492d5203b4d1635d5302b627))
* **deps:** Bump renovatebot/github-action from 46.1.7 to 46.1.12 ([#1937](https://github.com/eatmyrust/fluent-operator/issues/1937)) ([3f036c4](https://github.com/eatmyrust/fluent-operator/commit/3f036c4501b24948e404dc4a0d7a2c6811a9d61f))
* **deps:** Bump sigs.k8s.io/controller-runtime from 0.21.0 to 0.22.4 ([#1762](https://github.com/eatmyrust/fluent-operator/issues/1762)) ([9b82598](https://github.com/eatmyrust/fluent-operator/commit/9b8259867c5dbca58240e547b4c5e6eb02e65a8c))
* **deps:** Bump sigs.k8s.io/controller-runtime from 0.22.4 to 0.23.0 ([14663c1](https://github.com/eatmyrust/fluent-operator/commit/14663c18bbc7e11fccb8dcffbe643133e6dbee2c))
* **deps:** Bump sigs.k8s.io/controller-runtime from 0.23.0 to 0.23.1 ([#1855](https://github.com/eatmyrust/fluent-operator/issues/1855)) ([f2f7f2c](https://github.com/eatmyrust/fluent-operator/commit/f2f7f2c9642410cdf669e6f051456d7b9ed9e722))
* **deps:** Bump sigs.k8s.io/controller-runtime from 0.23.1 to 0.23.3 ([145d01c](https://github.com/eatmyrust/fluent-operator/commit/145d01cc042e464adbeaebfad1d478677564e035))
* **deps:** Bump sigs.k8s.io/controller-runtime from 0.23.3 to 0.24.0 ([#1942](https://github.com/eatmyrust/fluent-operator/issues/1942)) ([cf6aa0a](https://github.com/eatmyrust/fluent-operator/commit/cf6aa0a383fe20abede9efa1962c845137e8dcc8))
* **deps:** Bump sigs.k8s.io/controller-runtime from 0.24.0 to 0.24.1 ([#1960](https://github.com/eatmyrust/fluent-operator/issues/1960)) ([8db5f8c](https://github.com/eatmyrust/fluent-operator/commit/8db5f8cb50dc73f5bd3c7f48d7689223595a4caf))
* **deps:** Bump sigs.k8s.io/yaml from 1.4.0 to 1.6.0 ([d0a3ad4](https://github.com/eatmyrust/fluent-operator/commit/d0a3ad4e235f148d0852b9f73571f43d25a45015))
* **deps:** Bump the k8s-io group across 1 directory with 3 updates ([5238da7](https://github.com/eatmyrust/fluent-operator/commit/5238da7c6f313fc527b658c587c4871c3cd0b26f))
* **deps:** Bump the k8s-io group across 1 directory with 3 updates ([07cb71a](https://github.com/eatmyrust/fluent-operator/commit/07cb71af76b076033755082d21500ac678b45ee4))
* **deps:** Bump the k8s-io group across 1 directory with 3 updates ([595b920](https://github.com/eatmyrust/fluent-operator/commit/595b9207b3389b57ea82bb2e26e6c9c8da915a3c))
* **deps:** Bump the k8s-io group across 1 directory with 3 updates ([9fc2a2d](https://github.com/eatmyrust/fluent-operator/commit/9fc2a2da64c419527f55ec1f6e3244ab065d362c))
* **deps:** Bump the k8s-io group across 1 directory with 3 updates ([47ef128](https://github.com/eatmyrust/fluent-operator/commit/47ef128e8fba887339e9c3cc315eea1c41b7d4bc))
* **deps:** Bump the k8s-io group across 1 directory with 3 updates ([1dfe2e1](https://github.com/eatmyrust/fluent-operator/commit/1dfe2e1cb03e4bb5c41bb14b8bc6d9da44c66b0a))
* **deps:** Bump the k8s-io group across 1 directory with 3 updates ([#1872](https://github.com/eatmyrust/fluent-operator/issues/1872)) ([8bd2ce0](https://github.com/eatmyrust/fluent-operator/commit/8bd2ce0e2d23f5953d4b4f4080e4825df66351be))
* **deps:** Bump the k8s-io group across 1 directory with 3 updates ([#1957](https://github.com/eatmyrust/fluent-operator/issues/1957)) ([8b020f8](https://github.com/eatmyrust/fluent-operator/commit/8b020f8e03737065a10b04d90ca69d1b88292909))
